...
This implementation is using [Better Auth](https://better-auth.com/), using their social sign-on for Google and Github, and the Generic OAuth plugin for Keycloak.
...
For those using Google or GitHub, Better Auth's social sign-on is built to use a different callback URL. You **MUST** update the Authorization callback URL to use the new callback URL.
